...
function CreateAJob() {
  ...
  return (
    <div className='w-[800px] h-[300px] p-8 flex justify-center flex-col bg-slate-100 rounded-lg relative '>
        <div className='mb-8'>
           <p className='text-2xl font-semibold text-center'>
           Create a Job
            </p> 
        </div>
        <button className='absolute top-2 right-2'><IoCloseCircle color='red' size={30}></IoCloseCircle></button>
